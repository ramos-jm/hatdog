...
const  input = localStorage.getItem("inputtTextValue");
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof humanPercentage === "undefined" || humanPercentage === null) {
    ...
    mixedProgressBar.setAttribute('num', `${mixedPercentage}%`);
    mixedProgressBar.style.setProperty('--prcnt', `${mixedPercentage}`);
...
aiSentences.textContent = `${hLength}/${sentenceCount} Sentences likely AI generated`;
