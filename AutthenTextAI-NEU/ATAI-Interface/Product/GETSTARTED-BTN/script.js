...
agreeCheckbox.addEventListener("change", function() {
  ...
  inputText.addEventListener('input', function() {
    ...
    totalCharacters = `${this.value.length}`;
  ...
  function processInput(inputTextValue) {
    ...
    .then(result => { 
        ...
        const inputtTextValue = document.getElementById("inputText").value;
        localStorage.setItem("inputtTextValue", JSON.stringify(inputtTextValue));
